-- Backfill comparison pages after adding GDPval-AA and Toolathlon to the canonical vocabulary.
-- Migration 022 may already be applied in production, so this reruns the refresh using the corrected labels.
