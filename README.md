...
At `/admin`, the editorial workspace provides dedicated content editors for articles, guides, glossary entries, books, and chapters. Every editor includes an optional cover image URL and alt text, stored in Neon and used on the public page and social metadata. Articles and guides use ordered Markdown, comparison-table, and chart blocks; sources are managed separately and rendered at the end of the public page.
