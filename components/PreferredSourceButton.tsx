  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="inline-flex items-center gap-4 rounded-[1.5rem] border-2 border-[#777] bg-white px-5 py-2.5 text-left font-sans text-base font-medium leading-tight text-black shadow-sm transition-colors hover:bg-[#f5f5f5] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent sm:px-6 sm:text-lg"
      >
        <svg
          aria-hidden="true"
