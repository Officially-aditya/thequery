...
function SpecTableEditor({ block, onChange }: { block: SpecTableBlock; onChange: (next: Partial<SpecTableBlock>) => void }) {
  ...
  return (
    <div className="grid gap-3">
      ...
      <p className="text-xs text-text-muted">Section title and model names stick together while its table scrolls. Use <code>**bold**</code> on the winning value in each row.</p>
