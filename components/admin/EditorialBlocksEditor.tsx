...
function SpecTableEditor({ block, onChange }: { block: SpecTableBlock; onChange: (next: Partial<SpecTableBlock>) => void }) {
  ...
  return (
    <div className="grid gap-3">
      ...
      <p className="text-xs text-text-muted">Consecutive spec tables join into one table. Model names pin at the top; section heads swap beneath them. Use <code>**bold**</code> on the winning value in each row.</p>
